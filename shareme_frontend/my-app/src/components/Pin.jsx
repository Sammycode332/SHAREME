...
const Pin = ({ pin: {postedBy,image, _id,destination, save}})=> {
    ...
    const savePin = (_id) => {
      ...
      .insert('after', 'save[-1]', [
        {
        _key: uuidv4(),
        userId: userInfo?.sub, //user.googleId
        postedBy:{
          _type: 'postedBy',
          _ref: userInfo?.sub,
        }
                ...
                {destination && (
                 ...
                 {postedBy?._id === userInfo?.sub && (
                   <button
                    ...
                    className = "bg-white p-2 opacity-70 hover:opacity-100 font-bold text-darktext-base rounded-3xl hover:shadow-md outlined-none"
              >
                  <AiTwotoneDelete/>
              </button>
            )}
